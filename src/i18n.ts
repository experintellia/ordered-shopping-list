...
const en: UIStrings = {
  ...
  settings_notify: "Notify chat on changes",
  info_started: "{name} started a shared grocery list",
  info_updated: "{name} updated the grocery list",
...
const de: UIStrings = {
  ...
  settings_notify: "Chat bei Änderungen benachrichtigen",
  info_started: "{name} hat eine geteilte Einkaufsliste gestartet",
  info_updated: "{name} hat die Einkaufsliste aktualisiert",
